...
urlpatterns = [
    ...
    path('password_change/done/', auth_view.PasswordChangeDoneView.as_view(template_name='users/password_change_form.html', extra_context={'password_confirm' : True}), name='password_change_done'),
